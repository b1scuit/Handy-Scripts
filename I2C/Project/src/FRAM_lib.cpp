...
*/
/**************************************************************************/
bool FRAM_lib::begin(char i2c, uint8_t addr)
{
...
*/
/**************************************************************************/
void FRAM_lib::write8 (char i2c, uint16_t framAddr, uint8_t value){
  uint8_t bufferV[5] = {0};
...
uint8_t FRAM_lib::read8  (char i2c, uint16_t framAddr){
  uint8_t bufferV[5] = {0};
