...
export ZSH=/Users/peterholt/.oh-my-zsh
...
plugins=(git gitfast vi-mode zsh-completions fzf-marker)
...
alias gitcleanup="git branch --merged | egrep -v \"(^\*|master|develop)\" | xargs git branch -d"
export PATH="/usr/local/opt/node@6/bin:$PATH"

fzfsearch(){
	fzf --preview "pygmentize {} " --color light --margin 5,20
}
